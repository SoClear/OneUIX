...
object SystemUI {
            ...
            findAndHookMethod(
                ...
                object : XC_MethodHook() {
                    override fun afterHookedMethod(param: MethodHookParam) {
                        ...
                        restoreBatteryIconLayout(mBatteryIconView)
                        ...
                        forgetBatteryIconLayout(mBatteryIconView)
                    }
                }
            )
        } catch (t: Throwable) {
    ...
    fun hideBatteryIcon(loadPackageParam: LoadPackageParam) {
    ...
    private fun forgetBatteryIconLayout(iconView: ImageView) {
